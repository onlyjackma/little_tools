...
def entropy(bytes):
  ...
  # """...".."...node, .....node.ip, port, node ID...., .....UDP..,   
  # .........., ..."..".....ip.port., .........ip.port,   
  # ..... ......node........node ID.., .....node ID.sha1....,   
  # sha1..........20 byte, ...20 * 8 = 160 bit, ...DHT........: 0 . 2.160..,   
  # ........1461501637330902918203684832716283019655932542976......node.   
  # ok, ..sha1....20 byte.., ......SHA1(20).SHA1(19).SHA1("I am a 2B")...,   
  # .................. .., node ID.....,   
  # .....FF5C85FE1FDB933503999F9EB2EF59E4B0F51ECA...., ..hash.hexdigest(). """
def random_id():
  hash = sha1()
...
def intify(hstr):
  #"""......., ...node ID...... ........""" 
  return long(hstr.encode('hex'), 16)	#....16.., .....
...
# ......... 
class KTable(object):
  # ...nid....node_id().......node ID. ....., ..........bucket,   
 #	......bucket.min=0, max=2^160.., ..........buckets.....bucket, ......
  ...
  def append(self, node):
    ...
    # .....node ID.infohash...K.node.  
 
    # ......node ID.infohash...bucket, ...bucuck.K..., ...   
    # .....K....., ..bucket...bucket..bucket...bucket..., ....K....  
    # ....K.., ........ .................  
    # .., ........, .........K....  
  ...
  def bucket_index(self, target):
    ...
    # index.....bucket(old bucket).......   
    # ....old bucket.min:0, max:16. ...old bucket.., ....8, ...old bucket.max..8, min..0.   
    # ......bucket, new bucket.min=8, max=16.  
    # .....old bucket....node.nid, .......bucket...., ......bucket..   
    # ....,.....  
    # new bucket........old bucket.., .index+1, ...bucket........ 
...
class KBucket(object):
  ...
  # min.max...bucket....., ...bucket.min:0, max:16..,   
  # .....node.intify(nid)...: 0.15, .16...., .16....bucket...bucket.min..   
  # nodes......., ..node. last_accessed........, .......,   
  # ..bucket...node..., ....; ..node; ..node; ..node; ......,   
  # .......bucket, .....last_accessed.., ........bucket."....". .linux..., touch...  
  # ..................  
